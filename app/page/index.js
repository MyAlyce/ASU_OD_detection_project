...
import * as sleepUtils from './sleepFunctions'; // Import sleep functions
        ...
        build() {
			...
			hmUI.createWidget(hmUI.widget.BUTTON, {
				...
				click_func: () => {
					...
					sleepUtils.onClickSleepButton(permissions); // Ensure this matches the exported function name
				},
			});
